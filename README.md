if game:GetService("CoreGui"):FindFirstChild("1xlii HUB") then

   game:GetService("CoreGui"):FindFirstChild("1xlii HUB"):Destroy()
...
game.CoreGui:FindFirstChild("1xliiHUB").Enabled = not game.CoreGui:FindFirstChild("1xliiHUB").Enabled
...
egg:Toggle("Best Egg 🥚",false,function(State)
